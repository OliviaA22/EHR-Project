...
<a class="btn btn-primary" href="demorgraphics.php" role="button">Demorgraphics</a>
    <a class="btn btn-primary" href="MedicalHistory.php" role="button">Medical History</a>
    <a class="btn btn-primary" href="ImmunisationStatus.php" role="button">Immunisation Status</a>
    <a class="btn btn-primary" href="LaboratoryTest.php" role="button">Lab Tests</a>
    <a class="btn btn-primary" href="RadiologyImages.php" role="button">Radiology Images</a>
    <a class="btn btn-primary" href="VitalSigns.php" role="button">Vital Signs</a>
    <a class="btn btn-primary" href="PersonalStatistics.php" role="button">Personal Statistics</a>
    <a class="btn btn-primary" href="BillingInformation.php" role="button">Billing Information</a>
</nav>
